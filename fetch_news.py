...
def fetch_news_data():
    today = date.today()
    api_key = 'ce6e370741c14dbc8401312dd86ac682'

    
    base_url = "https://newsapi.org/v2/everything?q=apple&from=2025-01-08&to=2025-01-08&sortBy=popularity&apiKey=ce6e370741c14dbc8401312dd86ac682"
    ...
    # Upload to GCS
    bucket_name = 'snowflake-projects_test'
